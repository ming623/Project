...
Human_Omega_Gene <- data.frame(name=c("SFR1","CRAP43","GSTO1","GSTO2","ITPRIP","CFAP58"),
                               ...
                               col = c("white","white","green","red","white","white"))
...
Baboon_Omega_Gene <- data.frame(name=c("COL17A1","SFR1","GSTO1","GSTO2","ITPRIP","CFAP58"),
                             start = c(1000,1100,1200,1300,1400,1500),
                             end = c(1050,1150,1250,1350,1450,1550),
                             strand = c(-1,1,1,1,-1,1),
                             col = c("white","white","green","red","white","white"))
...
Sheep_Omega_Gene <- data.frame(name=c("SFR1","CRAP43","GSTO1","GSTO2","GSTO3","ITPRIP","CFAP58"),
                               ...
                               col = c("white","white","green","green","red","white","white"))
...
Pig_Omega_Gene <- data.frame(name=c("COL17A1","SFR1","GSTOP1","GSTO1","GSTO2","ITPRIP","CFAP58"),
                             start = c(1000,1100,1200,1300,1400,1500,1600),
                             end = c(1050,1150,1250,1350,1450,1550,1650),
                             strand = c(-1,1,-1,1,1,1,-1),
                             col = c("white","white","white","green","red","white","white"))
...
Grayshorttailopossum_Omega_Gene <- data.frame(name=c("COL17A1","WDR96","GSTO2","SFR1","GSTO1","ITRIP","CCDC147"),
                                              start = c(1000,1100,1200,1300,1400,1500,1600),
                                              end = c(1050,1150,1250,1350,1450,1550,1650),
                                              strand = c(-1,-1,-1,1,1,-1,1),
                                              col = c("white","white","red","white","green","white","white"))
